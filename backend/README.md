...
## Project Structure
    ...
    ├── testapiautodatamod_118172  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_118172`
...
2. Clone this repo and `cd testapiautodatamod_118172`
